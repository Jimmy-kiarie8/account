...
return [
    ...
    'api_key_link'          => '<a class="text-red" href="http://127.0.0.1:8000/profile" target="_blank">Πατήστε εδώ</a> για να πάρετε το API κλειδί σας.',
    'no_apps'               => 'Δεν υπάρχουν εφαρμογές σε αυτή την κατηγορία, ακόμα.',
    'developer'             => 'Είστε προγραμματιστής;<a href="http://127.0.0.1:8000/developers" target="_blank">Εδώ</a> εδώ μπορείτε να μάθετε πώς να δημιουργήσετε μια εφαρμογή και να ξεκινήσετε να την πουλάτε σήμερα!',
