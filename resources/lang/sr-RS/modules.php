...
return [
    ...
    'install'               => 'Инсталирај',
    'buy_now'               => 'Купи одмах',
    'token_link'            => '<a href="http://127.0.0.1:8000/tokens" target="_blank">Кликните овде</a> да бисте добили свој API token.',
    'no_apps'               => 'У овој категорији још нема апликација.',
    'developer'             => 'Јеси ли програмер? <a href="http://127.0.0.1:8000/blog/akaunting-app-store" target="_blank">Овде </a> можете научити како креирати апликацију и можеш да почнеш да је продајеш!',
