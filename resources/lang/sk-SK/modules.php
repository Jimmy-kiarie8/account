...
return [
    ...
    'install'               => 'Inštalovať',
    'buy_now'               => 'Kúpiť teraz',
    'token_link'            => '<a href="http://127.0.0.1:8000/tokens" target="_blank">Kliknite tu</a> a získajte Váš API token.',
    'no_apps'               => 'Neexistujú žiadne aplikácie v tejto kategórii zatiaľ.',
    'developer'             => 'Ste vývojár? tu <a href="http://127.0.0.1:8000/blog/akaunting-app-store" target="_blank"></a> sa môžete naučiť, ako vytvoriť aplikáciu a začať predávať ešte dnes!',
