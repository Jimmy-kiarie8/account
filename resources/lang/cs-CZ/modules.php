...
return [
    ...
    'install'               => 'Instalovat',
    'buy_now'               => 'Koupit',
    'api_key_link'          => '<a class="text-red" href="http://127.0.0.1:8000/profile" target="_blank">Klikněte zde</a> pro získání API klíče.',
    'no_apps'               => 'V této kategorii zatím nejsou žádné aplikace.',
    'developer'             => 'Jste vývojář? <a href="http://127.0.0.1:8000/blog/akaunting-app-store" target="_blank"> Zde</a> se můžete naučit, jak vytvořit aplikaci a začít hned prodávat!',
